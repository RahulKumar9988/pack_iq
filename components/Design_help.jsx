...
export function Design_help() {
  const data = [
      ...
      content: (
        <div>
          <p
            ...
            Recieve the questionnaire to fill out and a link to upload your assets
          </p>
    ...
    {
      title: "30-minute phone conversation",
      content: (
        <div>
          <p
    ...
    {
        title: "Design 3 custom concepts",
        content: (
          <div>
            <p
              className="mb-4 text-sm font-normal text-neutral-800 md:text-xl dark:text-neutral-200">
              You then choose you favorite concept
            </p>
    ...
    },
    {
        ...
        content: (
          <div>
            <p
              className="mb-4 text-sm font-normal text-neutral-800 md:text-xl dark:text-neutral-200">
              We will finalize your layout and provide you with a final print file you can use to place your order
            </p>
