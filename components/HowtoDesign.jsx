...
const HowtoDesign = () => {
  const timelineData = [
    ...
    },
    {
      ...
      description:"Have a design ready? Upload it now — or reach out if you need help creating one. OR Upload your ready-to-go design file or contact us if you need assistance in creating one. ",
      color: "bg-blue-200",
            ...
            {timelineData.map((item) => (
              <React.Fragment key={item.id}>
                <div className="relative flex items-center">
                  ...
                  <div className={`ml-12 flex-1 ${item.color} rounded-r-full border border-gray-200 px-8 md:px-12 py-20 shadow-sm`}>
