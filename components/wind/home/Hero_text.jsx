            ...
            <div className="w-full max-w-6xl">
              ...
              >
                ...
                <motion.div variants={itemVariants} className="w-full">
                  <h1 className="text-gray-900 text-xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl font-bold leading-tight sm:leading-tight md:leading-tight lg:leading-tight tracking-tight">
                    Turning Your Product Ideas Into{" "} <br />
                    <span className="relative inline-block">
                      <span className="md:text-6xl bg-gradient-to-r from-blue-900 to-blue-950 bg-clip-text text-transparent font-extrabold">
