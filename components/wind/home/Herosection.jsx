...
export default function HeroSection({ inter }) {
  ...
  return (
    <div className="md:mt-10 rounded-3xl flex flex-col sm:flex-row justify-between w-full min-h-[80vh] sm:h-[70vh] md:h-[75vh] lg:h-[78vh] overflow-hidden bg-gradient-to-br from-indigo-100 via-white to-indigo-100 px-4 sm:px-0">
